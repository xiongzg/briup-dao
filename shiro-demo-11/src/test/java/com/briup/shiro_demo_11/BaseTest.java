package com.briup.shiro_demo_11;
...
public abstract class BaseTest {
    ...
    public void setUp() {
        ...
        //1、新增权限
        p1 = new Permission("user:create", "用户模块新增_缓存", Boolean.TRUE);
        p2 = new Permission("user:update", "用户模块修改_缓存", Boolean.TRUE);
        p3 = new Permission("menu:create", "菜单模块新增_缓存", Boolean.TRUE);
        permissionService.createPermission(p1);
        permissionService.createPermission(p2);
        permissionService.createPermission(p3);
        //2、新增角色
        r1 = new Role("admin", "管理员_缓存", Boolean.TRUE);
        r2 = new Role("user", "用户管理员_缓存", Boolean.TRUE);
